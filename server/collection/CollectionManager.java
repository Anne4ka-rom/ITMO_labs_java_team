...
public class CollectionManager { // объявляем класс для управления коллекцией
    ...
    /**
     * Возвращает все элементы коллекции в виде списка без сортировки
     * Возвращает копию текущего состояния коллекции для безопасной передачи
     * 
     * @return новый список со всеми элементами коллекции в порядке их хранения в стеке
     */
    public List<Vehicle> getAllUnsorted() { // метод получения всех элементов без сортировки
        return new ArrayList<>(collection); // создаем новый список-копию из стека и возвращаем его
    }
